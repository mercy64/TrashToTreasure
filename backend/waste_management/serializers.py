...
class WasteListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = WasteListing
        fields = ['id', 'title', 'description', 'type', 'quantity', 'unit', 
                 'location', 'latitude', 'longitude', 'price_per_unit', 'status', 
                 'user', 'images', 'created_at', 'updated_at']

class WasteListingCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = WasteListing
        fields = ['title', 'description', 'type', 'quantity', 'unit', 
                 'location', 'latitude', 'longitude', 'price_per_unit']
...
class TransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transaction
        fields = ['id', 'listing', 'buyer', 'seller', 'quantity', 'total_amount', 
                 'status', 'payment_reference', 'delivery_address', 'pickup_date', 
